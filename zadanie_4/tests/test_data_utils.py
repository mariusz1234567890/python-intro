...
from lab_3_lib.data_utils import filter_even_numbers

# Import konkretnej funkcji merge_dicts z pliku o nazwie app.py, którą chcemy przetestować.
from lab_3_lib.data_utils import merge_dicts
